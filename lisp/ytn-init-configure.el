...
(require 'ivy) ;; これやらないと最初のバイトコンパイルで Warning が出る
...
(defun ytn-init-configure()
  ...
  (use-package winum
    :commands (winum-mode winum-select-window-1 winum-select-window-2 winum-select-window-3 winum-select-window-4
                          winum-select-window-5 winum-select-window-6 winum-select-window-7 winum-select-window-8
...
;;           (call-interactively fun)))))
  ...
  (use-package yasnippet
    ...
    :commands (yas-global-mode yasnippet-snippets-initialize)
    :init
    (yas-global-mode 1)
    :config
