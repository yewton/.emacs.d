...
(defun toncs-ad-dirvish-activate (&rest _)
  (setq dirvish-saved-display-buffer-alist display-buffer-alist))

(defun toncs-ad-dirvish-deactivate (&rest _)
...
(defun toncs-config-dired-configure ()
  ...
  ;; Dirvish に display-buffer-alist を消去されないようにする
  ;; see https://github.com/alexluigit/dirvish/issues/9
  (advice-add 'dirvish-activate :before #'toncs-ad-dirvish-activate)
  (advice-add 'dirvish-deactivate :before #'toncs-ad-dirvish-deactivate)
