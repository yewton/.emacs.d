...
(defun toncs-server-prompt-edit-setup()
  (when (and buffer-file-name (or
                               (string-match-p "/gemini-edit-.+/buffer\\.txt\\'" buffer-file-name)
                               (string-match-p "/copilot-edit-.+/COPILOT_PROMPT\\.md\\'" buffer-file-name)
                               (string-match-p "/claude-prompt-.+\\.md\\'" buffer-file-name)))
    (general-def 'local
