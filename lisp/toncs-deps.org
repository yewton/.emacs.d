...
(defconst toncs-deps-minimum
  '((:name el-get)
    ...
    (:name no-littering :checkout "e0f8daa7c374cd91d9c4e89cbdda6e0e7fe24317")
    ...
    (:name ddskk :checkout "eede626d70953715d2405b325dcb151b7cb597e7")
...
(defconst toncs-deps-extra
  '((:name rainbow-identifiers :shallow t :branch "0.2.2")
    ...
    (:name dirvish :checkout "0d21876b8a5db2e2d5999ddbe0514c6e0c0bd79d")
