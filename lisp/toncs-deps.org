...
(defconst toncs-deps-minimum
  '((:name el-get)
    ...
    (:name org-mode :checkout "release_9.5.4"
...
(defconst toncs-deps-extra
  '((:name rainbow-identifiers :shallow t :branch "0.2.2")
    ...
    (:name svg-lib :checkout "303f690389f71fd8efb8f43931e835d8b3db28d4")
    (:name svg-tag-mode :checkout "efd22edf650fb25e665269ba9fed7ccad0771a2f"))
