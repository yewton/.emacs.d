...
#+BEGIN_SRC emacs-lisp :noweb yes
  ...
  (setq el-get-sources
        '((:name spaceline :type github :pkgname "TheBB/spaceline" :depends (powerline dash s))
          ...
          (:name kotlin-mode :type github :pkgname "Emacs-Kotlin-Mode-Maintainers/kotlin-mode")
          (:name package :after
          ...
          (:name plantuml-mode :type github :pkgname "skuro/plantuml-mode"
                 :after (let ((plantuml-url "http://sourceforge.net/projects/plantuml/files/plantuml.jar/download")
                 ...
                 :before (setq plantuml-jar-path
                               (expand-file-name "plantuml.jar" default-directory)))
          (:name ripgrep :type github :pkgname "nlamirault/ripgrep.el")
          (:name github-modern-theme :type github :pkgname "philiparvidsson/GitHub-Modern-Theme-for-Emacs"
                 :autoload nil
